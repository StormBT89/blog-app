...
export default function UpdatePost() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPublishError('Постојат проблеми со ажурирањето на состанокот');      
    }
  }

  return (
    <div className="p-3 max-w-3xl mx-auto min-h-screen">
      <h1 className="text-center text-3xl my=7 font-semibold mb-4">Ажурирање на податоци за состанокот</h1>        
      <form className="flex flex-col gap-4" onSubmit={handleSubmit} >
        ...
        <Textarea value={formData.content} onChange={(e) => setFormData({...formData, content: e.target.value})} id='content' placeholder='Инфо за состанок..' required rows={5}>
        </Textarea>
